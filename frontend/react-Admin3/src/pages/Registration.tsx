			...
			{vm.error && (
				<Box sx={{ maxWidth: 700, mx: 'auto', mb: 4 }}>
					...
					>
						...
						<Typography variant="body2">{vm.error}</Typography>
					</Alert>
				</Box>
			)}

			<UserFormWizard
				onSuccess={vm.handleRegistrationSuccess}
				onError={vm.handleRegistrationError}
				onSwitchToLogin={vm.handleSwitchToLogin}
			/>
