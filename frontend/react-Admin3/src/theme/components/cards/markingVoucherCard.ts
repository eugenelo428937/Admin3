...
import { fontSizes as _fontSizes } from '../../tokens/typography';
import { markingVoucher } from '../../semantic/productCards';
import { semantic } from '../../semantic/common';

// Cast to any to preserve legacy shorthand property access (e.g. spacing.xl15, fontSizes.body1)
...
export const markingVoucherCardStyles = {
  ...
  "& .floating-badges-container": {
    "& .expiry-badge": {
      // Note: original JS had duplicate backgroundColor here; the second value wins
