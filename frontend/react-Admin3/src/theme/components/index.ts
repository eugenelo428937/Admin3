...
import { cardOverrides } from './cards/index';
 ...
 */
function deepMergeOverrides(target: Record<string, any>, source: Record<string, any>): Record<string, any> {
  const result = { ...target };
 ...
 */
function mergeComponentOverrides(...sources: Record<string, any>[]): Record<string, any> {
