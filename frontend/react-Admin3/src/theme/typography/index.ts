...
import spacingTokens, { spacing as _spacing } from '../tokens/spacing';
...
// (e.g. fontSizes.h3, fontSizes.price, fontSizes.body1, spacing.xs3)
const fontSizes = _fontSizes as any;
const spacing = _spacing as any;
// =============================================================================
// Helper: Add !important to CSS values for MUI specificity
// =============================================================================
const important = (value: string | number): string => `${value} !important`;
...
export const typographyConfig = {
  ...
  logo_bpp:{
    ...
    letterSpacing: important(letterSpacings.scale[10]),
  ...
  title_onlineStore:{
    ...
    letterSpacing: important(letterSpacings.scale[50]),
    textWrap: 'balance',
    color: md3.inverseOnSurface,
  },
  // Heading variants
  h1: {
    ...
    lineHeight: important(lineHeights.short),
    letterSpacing: important(letterSpacings.scale[40]),
    textWrap: 'balance',
  },
  h2: {
  ...
  caption2: {
    fontFamily: fontFamilies.inter,
    fontWeight: fontWeights.regular,
    fontSize: important(fontSizes.caption.small),
    lineHeight: important(lineHeights.normal),
    letterSpacing: important(letterSpacings.scale[80]),
  },
