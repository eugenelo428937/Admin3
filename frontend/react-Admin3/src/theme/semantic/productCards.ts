...
// Type Exports
// =============================================================================
export type ProductCardColors = typeof productCards[keyof typeof productCards];
export type ProductCardType = keyof typeof productCards;
export type ProductCardsTokens = typeof productCards;

// =============================================================================
// Helper: Get colors by product type (for dynamic access)
// =============================================================================
export const getProductCardColors = (productType: string): ProductCardColors => {
  return productCards[productType as ProductCardType] || tutorial; // Default to tutorial
};
