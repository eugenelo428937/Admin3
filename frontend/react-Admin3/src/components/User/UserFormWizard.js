				...
				return (
					<Box>
						...
						<Grid
							...
							<Grid size={4}>
								<Box className={shakingFields.has('first_name') ? 'field-error-shake' : ''}>
									<TextField
										fullWidth
										required
										label="First Name"
										...
										error={hasUserInteracted && !!fieldErrors.first_name}
										helperText={hasUserInteracted ? fieldErrors.first_name : ''}
							...
							<Grid size={4}>
								<Box className={shakingFields.has('last_name') ? 'field-error-shake' : ''}>
									<TextField
										fullWidth
										required
										label="Last Name"
										...
										onChange={handleChange}
										error={hasUserInteracted && !!fieldErrors.last_name}
										helperText={hasUserInteracted ? fieldErrors.last_name : ''}
							...
							<Grid size={12} sx={{ textAlign: "left" }}>
								<Box className={shakingFields.has('email') ? 'field-error-shake' : ''}>
									<TextField
										fullWidth
										required
										type="email"
							...
							<Grid size={12}>
								<Box className={shakingFields.has('home_phone') ? 'field-error-shake' : ''}>
									<ValidatedPhoneInput
										name="home_phone"
										...
										isInvalid={hasUserInteracted && !!fieldErrors.home_phone}
										error={hasUserInteracted ? fieldErrors.home_phone : ''}
							...
							<Grid size={12}>
								<Box className={shakingFields.has('mobile_phone') ? 'field-error-shake' : ''}>
									<ValidatedPhoneInput
										name="mobile_phone"
										...
										isInvalid={hasUserInteracted && !!fieldErrors.mobile_phone}
										error={hasUserInteracted ? fieldErrors.mobile_phone : ''}
							...
							<Box>
								<Grid container spacing={3} sx={{ mb: 3 }}>
									<Grid size={{ xs: 12, md: 6 }}>
										<Box className={shakingFields.has('work_company') ? 'field-error-shake' : ''}>
											<TextField
												fullWidth
												required
												...
												onChange={handleChange}
												error={hasUserInteracted && !!fieldErrors.work_company}
												helperText={hasUserInteracted ? fieldErrors.work_company : ''}
												variant="standard"
											/>
										</Box>
									</Grid>
								...
								<Grid container spacing={3} sx={{ mt: 2 }}>
									<Grid size={{ xs: 12, md: 6 }}>
										<Box className={shakingFields.has('work_phone') ? 'field-error-shake' : ''}>
											<ValidatedPhoneInput
												name="work_phone"
												value={form.work_phone}
												onChange={handleChange}
												onValidationChange={handleWorkPhoneValidation}
												countries={countryList}
												selectedCountry={workPhoneCountry}
												onCountryChange={setWorkPhoneCountry}
												isInvalid={hasUserInteracted && !!fieldErrors.work_phone}
												error={hasUserInteracted ? fieldErrors.work_phone : ''}
				...
				return (
					<Box sx={{ minHeight: "400px" }}>
						...
						<Grid container spacing={3}>
							<Grid size={{ xs: 12, md: 6 }}>
								<Box className={shakingFields.has('password') ? 'field-error-shake' : ''}>
									<TextField
										fullWidth
										required
										type="password"
										...
										value={form.password}
										onChange={handleChange}
										error={hasUserInteracted && !!fieldErrors.password}
										helperText={
							...
							<Grid size={{ xs: 12, md: 6 }}>
								<Box className={shakingFields.has('confirmPassword') ? 'field-error-shake' : ''}>
									<TextField
										fullWidth
										required
										type="password"
										...
										onChange={handleChange}
										error={hasUserInteracted && !!fieldErrors.confirmPassword}
										helperText={hasUserInteracted ? fieldErrors.confirmPassword : ''}
