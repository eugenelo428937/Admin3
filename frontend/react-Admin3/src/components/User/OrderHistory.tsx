...
import { useOrderHistoryVM } from "./useOrderHistoryVM";
import type { Order, OrderItem, TutorialChoice, TutorialLocation } from "../../types/auth";

const OrderHistory: React.FC = () => {
  const { orders, loading, error } = useOrderHistoryVM();
                          ...
                          <Box sx={{ mt: 2, mb: 2, fontSize: '0.85em' }}>
                            {item.metadata.locations ? (
                              ...
                              <>
                                ...
                                {item.metadata.locations.map((location: TutorialLocation, locationIndex: number) => (
                                  <Box key={locationIndex} sx={{ mt: 2, border: 1, borderColor: 'divider', borderRadius: 1, p: 2 }}>
                                    ...
                                    {location.choices.map((choice: TutorialChoice, choiceIndex: number) => (
                              ...
                              <>
                                ...
                                {item.metadata.choices.map((choice: TutorialChoice, index: number) => (
