...
// src/components/User/__tests__/EmailVerification.test.tsx
...
describe('EmailVerification', () => {
  ...
  describe('loading state', () => {
    test('shows loading spinner initially', () => {
      ...
      (authService.verifyEmailChange as any).mockImplementation(
        () => new Promise((resolve: any) => setTimeout(() => resolve({ status: 'success' }), 1000))
      );
  ...
  describe('successful verification', () => {
    test('shows success message on successful verification', async () => {
      ...
      (authService.verifyEmailChange as any).mockResolvedValueOnce({ status: 'success' });
  ...
  describe('failed verification', () => {
    test('shows error message on failed verification', async () => {
      ...
      (authService.verifyEmailChange as any).mockResolvedValueOnce({
        status: 'error',
    ...
    test('shows error on API exception', async () => {
      ...
      (authService.verifyEmailChange as any).mockRejectedValueOnce(new Error('Network error'));
    ...
    test('shows possible reasons for failure', async () => {
      ...
      (authService.verifyEmailChange as any).mockResolvedValueOnce({ status: 'error' });
