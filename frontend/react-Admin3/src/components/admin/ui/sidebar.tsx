...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "tw:relative tw:flex tw:min-w-0 tw:flex-1 tw:flex-col tw:bg-background",
