...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "tw:flex tw:w-full tw:items-center tw:justify-between tw:gap-2 tw:rounded-lg tw:border-[1.5px] tw:border-[var(--border)] tw:bg-[var(--card)] tw:px-3.5 tw:py-2.5 tw:text-[13px] tw:whitespace-nowrap tw:shadow-none tw:transition-[border-color,box-shadow] tw:duration-200 tw:outline-none tw:focus-visible:border-[var(--ring)] tw:focus-visible:shadow-[0_0_0_3px_rgba(0,0,0,0.03)] tw:disabled:cursor-not-allowed tw:disabled:opacity-50 tw:aria-invalid:border-destructive tw:aria-invalid:ring-destructive/20 tw:data-[placeholder]:text-muted-foreground tw:data-[size=default]:h-auto tw:data-[size=sm]:h-8 tw:*:data-[slot=select-value]:line-clamp-1 tw:*:data-[slot=select-value]:flex tw:*:data-[slot=select-value]:items-center tw:*:data-[slot=select-value]:gap-2 tw:dark:bg-[var(--card)] tw:dark:hover:bg-[var(--card)] tw:dark:aria-invalid:ring-destructive/40 tw:[&_svg]:pointer-events-none tw:[&_svg]:shrink-0 tw:[&_svg:not([class*=size-])]:size-4 tw:[&_svg:not([class*=text-])]:text-muted-foreground",
        className
      )}
      {...props}
    >
