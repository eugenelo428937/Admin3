...
const ProductCardVariantsDemo = () => {
	...
	return (
		<Box sx={{ p: theme.liftkit.spacing.lg }}>
			<Typography variant="h3" gutterBottom>
				Product Card Variants
			</Typography>
			<Typography variant="body1" sx={{ mb: theme.liftkit.spacing.lg }}>
			...
			<Grid container spacing={3}>
				<Grid size={{ xs: 12, md: 6, lg: 3 }}>
					<Box>
						...
						<Typography variant="caption" sx={{ mb: theme.liftkit.spacing.md, display: "block" }}>
