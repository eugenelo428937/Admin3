...
- Python 3.14, Django 5.1 + Django REST Framework + Rules Engine (`rules_engine` app), Cart Services (`cart` app), Utils (`utils` app) (20260114-20260121-remove-legacy-vat)
- PostgreSQL (existing `acted` schema, `vat_audit` table to be dropped) (20260114-20260121-remove-legacy-vat)
