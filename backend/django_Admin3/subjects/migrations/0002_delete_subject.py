...
#
# Subject model has been moved to catalog app.
# This migration updates Django's state WITHOUT deleting the database table.
# The old table (acted_subjects) is preserved per "Copy and Preserve" strategy.

from django.db import migrations


class Migration(migrations.Migration):
    """State-only migration: Subject moved to catalog app."""
