    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['entity_type'], name='customfield_entity__a50e73_idx'), models.Index(fields=['external_id'], name='customfield_externa_5b4667_idx')],
            },
        ),
    ]
